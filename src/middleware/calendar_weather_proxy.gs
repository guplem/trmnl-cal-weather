// GENERATED FILE - do not edit directly. Edit src/lib/middleware.js and src/middleware/calendar_weather_proxy.gs.template, then run `bun run build`.
/**
 ...
 * @returns {string}
 */
function cleanTextPure(text, maxTextLength) {
  if (!text) return '';
